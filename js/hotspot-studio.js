/**
 * Hotspot Studio Logic - Wrapped in IIFE to prevent Identifier Re-declaration Errors
 */
(function () {
    if (window.hotspotStudioScriptLoaded) return;
    ...
    window.hotspotStudioScriptLoaded = true;
})();
