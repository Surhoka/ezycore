...
window.appInitMixin = function () {
    const getWebAppUrl = () => {
        try {
            const config = JSON.parse(localStorage.getItem('EzycoreConfig') || localStorage.getItem('EzypartsConfig') || '{}');
        ...
        async checkInitialSetup() {
            ...
            try {
                ...
                const data = await this.fetchJsonp(webappUrl, {
                    ...
                    siteKey: (JSON.parse(localStorage.getItem('EzycoreConfig') || localStorage.getItem('EzypartsConfig') || '{}')).siteKey || ''
                });
