...
(function () {
    ...
    function initPublicDiscovery() {
        ...
        let siteKey = localStorage.getItem('Ezycore_SiteKey');
        ...
        if (bin && bin.textContent.trim()) {
            try {
                ...
                localStorage.setItem('Ezycore_SiteKey', siteKey);
